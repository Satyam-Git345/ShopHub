      ...
      <div style={{
        ...
        <nav style={{
          ...
          onMouseLeave={(e) => {
            ...
            {/* Cart Icon */}
            <svg width="22" height="22" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M9 2L7.17 4M15 2l1.83 2M9 22h6M10 17h4" 
                    stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
              <path d="M3.34 7h17.32c1.14 0 1.93 1.11 1.57 2.16l-2.31 6.73c-.32.93-1.19 1.55-2.17 1.55H6.25c-.98 0-1.85-.62-2.17-1.55L1.77 9.16C1.41 8.11 2.2 7 3.34 7z" 
                    stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
            </svg>
            <span style={{
              display: window.innerWidth > 768 ? 'inline' : 'none',
